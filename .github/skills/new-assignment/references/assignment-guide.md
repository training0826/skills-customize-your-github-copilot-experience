...
By separating this from SKILL.md, we keep the main instructions focused on workflow while this file provides domain knowledge. The agent only reads it when it reaches the gather-requirements step.
